...
\begin{longtabu}{|X[0.8,c]|X[3,c]|X[0.5,c]|}
  ...
  \rvin{O} & Il linguaggio di programmazione per la scrittura dello \textit{smart contract} in Ethereum dovrà essere Solidity. & Interna \\ 
  
  \hline

  \rvin{O} & La libreria deve funzionare correttamente con JavaSE 15 in poi. & Interna \\ 
