...
\begin{longtabu}{|c|X|}
  ...
  \personalGoal{O} \label{personal-goal:O.smart-contract} & Implementazione del 80\% dei contratti per la gestione di NFT \\
  \personalGoal{O} \label{personal-goal:O.library} & Implementazione della libreria per la comunicazione di NFTLab \\
