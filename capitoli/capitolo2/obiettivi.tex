...
\begin{longtabu}{|c|X|}
  ...
  \personalGoal{O} \label{personal-goal:O.smart-contract} & Implementazione del 80\% dei contratti per la gestione di NFT previsti \\
  \personalGoal{O} \label{personal-goal:O.library} & Implementazione della libreria per la comunicazione di NFTLab con i contratti sviluppati \\

  \hline

  \textbf{Desiderabile} &  \\
  
  \personalGoal{D} \label{personal-goal:D.smart-contract} & Implementazione del 100\% dei contratti previsti \\

  \hline

  \textbf{Facoltativo} & \\

  \personalGoal{F} \label{personal-goal:F.tests} & Implementazione dei \textit{test} relativi alle implementazioni realizzate \\
